alter sequence users_sequence restart with 20;
...
insert into users (id,email,password_hash,first_name,last_name,activated,created_by,created_date,last_modified_by)
values(2,'user@localhost', '$2a$10$VEjxo0jq2YG9Rbk2HmX9S.k1uZBGYUHdUcid3g/vfiEl7lwWgOH/K','User','User',true,'system','2018-06-20 10:00:00','system');
